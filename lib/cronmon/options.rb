  ...
  class Options < OpenStruct
    ...
    def files
      if(@files.nil? or @files.empty?)
        @files = ["#{File.join(File.dirname(__FILE__), "defaults.yml").to_s}",Cronmon::AUTH_CONFIG_FILE,Cronmon::TASKS_CONFIG_FILE,Cronmon::SETTINGS_CONFIG_FILE,File.expand_path("~/.cronmon.yml")]
      end
      @files
    end
